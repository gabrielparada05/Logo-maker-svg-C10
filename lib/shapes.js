...
class Shape {
  ...
  class Square extends Shape {
    ...
    render() {
        ...
        <rect x='100' y='50' fill='${this.fill}' stroke='${this.fill}'  stroke-width="5" width='100' height='100'/> <text x="50" y="80" text-anchor="middle" dominant-baseline="middle" fill="${this.textColor}" font-family="Futura, helvetica" font-weight="bolder" font-size="45px">${this.text} </text> </svg>`
  }
}
