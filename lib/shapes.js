...
class Shape {
  ...
  class Square extends Shape {
    ...
    print() {
        ...
        <rect x='${this.x}' y='${this.y}' fill='${this.fill}' stroke='${this.stroke}'  stroke-width='${this.strokeWidth} width='${this.width}' height='${this.height}'/> <text x="35" y="35" text-anchor="middle" dominant-baseline="middle" fill="#08a1ee">Hello</text> </svg>`
  }
}
  ...
  class Circle extends Shape {
    ...
    print() {
        return `<svg xmlns='http://www.w3.org/2000/svg'>
        <circle x='${this.x}' y='${this.y}' fill='${this.fill}' stroke='${this.stroke}'  stroke-width='${this.strokeWidth} radius='${this.radius}' cx='${this.cx} cy='${this.cy}'/>    <text x="50" y="50" text-anchor="middle" dominant-baseline="middle" fill="#08a1ee">Hello</text> </svg>`;
    }
  }
...
// Child class for triangle
  class Triangle extends Shape {
    ...
    print() {
        return `<svg xmlns='http://www.w3.org/2000/svg'>
        <polygon x='${this.x}' y='${this.y}' fill='${this.fill}' stroke='${this.stroke}'  stroke-width='${this.strokeWidth} points='${this.x1}, ${this.y1}, ${this.x2}, ${this.y2}, ${this.x3}, ${this.y3}'/> <text x="50" y="80" text-anchor="middle" dominant-baseline="middle" fill="#08a1ee">HELLO</text> </svg>`;
    }
  }
